            ...
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="email" type="email" class="form-input w-full @error('email') border-red-500 @enderror" placeholder="メールアドレス" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="password" type="password" placeholder="パスワード" class="form-input w-full @error('password') border-red-500 @enderror" name="password" required>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <p class="w-full text-xs text-center text-gray-700 my-6 sm:text-sm sm:my-8 flex justify-between">
                            <span>
                                アカウントをお持ちでない場合 &RightArrow;
                            </span>
            ...
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <div class="externel--login p-10">
                    ...
                    <a class="twitter--link__animaition" title="Follow @MikeMJHarris on Twitter" target="_blank" href="https://twitter.com/intent/follow?original_referer=http%3A%2F%2Flocalhost%3A8000%2Fposts%23&amp;region=follow_link&amp;screen_name=MikeMJHarris&amp;tw_p=followbutton">
                        <svg class="twitter--svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-450 -100 600 200" version="1.0">
                            <g transform="">
                ...
                <div class="mx-auto">
                    <span class="pl-7 block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                        とらのあな通販で登録
                    </span>
                    <div class=" pb-13">
