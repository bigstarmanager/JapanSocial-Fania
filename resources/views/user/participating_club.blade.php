    ...
    <div class="flex">
        ...
        <div class="w-3/4">
            <div class="border-1 main--border__color rounded-lg text-gray-500 bg-white">
                ...
                <div class="flex">
                    <div class="w-1/2 tab-active text-pink-500 text-center border-b-4 border-pink-500 py-5 font-bold"><a href="{{route('participating_club')}}"><span>有料プラン</span></a></div>
                    <div class="w-1/2 font-bold text-center py-5 border-l-1 border-b-1 main--border__color"><a href="{{route('participating_club__free')}}"><span>無料プラン</span></a></div>
                </div>
            ...
            <div class="paid--plan mt-5">
                <img src="{{asset('images/common/paid_plan.png')}}" class="border-1 rounded-lg main--border__color" width="100%" height="auto">
            </div>
