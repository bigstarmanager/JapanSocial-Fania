...
<div class="container mx-auto mt-10 text-gray-500">
    <div class="flex">
        ...
        <div class="w-3/4">
            <div class="border-1 main--border__color rounded-lg overflow-hidden text-gray-500 bg-white">
                <div class="p-5 border-b-1 main--border__color">
                    <h1 class="panel-title">お友達を招待してとらコインをGET！</h1>
                </div>
                <div class="border-b-1 main--border__color">
                    <img src="{{asset('images/common/get_coin.jpg')}}" width="100%" alt="">
                </div>
                <div class="relative">
                    <img src="{{asset('images/common/friend.png')}}" width="100%" alt="">
                    <div class="p-3 absolute w-full" style="bottom: 3px; left: 0;">
                        <p class="text-center bg-blue-100 px-3 py-6 hover:bg-blue-200 rounded"><a href="https://twitter.com/fantia_jp" target="_blank" class="text-blue-400 hover:underline "><b >公式Twitterをフォローしてお得なキャンペーン情報を受け取ろう！</b><i class="fa ml-2 fa-external-link"></i></a></p>
                    </div>
                </div>
            </div>
        </div>
